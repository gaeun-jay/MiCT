...
(function () {
  const DICT = {
    en: {
      ...
      login_signup: "New here? Create an account",
      ...
      reg_age_ph: "Select",
      reg_id: "ID",
      reg_id_ph: "Choose an ID",
      reg_pw: "Password",
      reg_pw_ph: "8+ chars, letters & numbers",
      reg_submit: "Register",
      reg_creating: "Creating…",
      reg_have_account: "Already have an account? Log in",
      reg_err_name: "Please enter your first and last name.",
      reg_err_age: "Please select your age group.",
      reg_err_id: "ID must be at least 3 characters (letters, numbers, underscore).",
      reg_err_pw: "Password must be 8+ characters with both letters and numbers.",
      reg_err_taken: "This ID is already taken. Please choose another.",
      reg_err_generic: "Registration failed. Please try again.",
      reg_done: "Account created! Redirecting…",
      // 비밀번호 변경
      cp_hello: "Hello, {name} !",
      ...
      err_submit: "Error during submit/grading:",
      err_generic: "Something went wrong.",
      code_run: "Run",
      code_output: "Output",
      code_stdin: "Input (stdin)",
      code_stdin_ph: "One value per line (for input())",
      code_running: "Running…",
      code_loading: "Loading Python…",
      code_no_output: "(no output)",
      code_timeout: "Execution timed out (possible infinite loop). Stopped after 10s.",
      code_loadfail: "Could not load Python. Check your connection and try again.",
      start: "Start",
    ...
    uk: {
      ...
      login_signup: "Немає акаунта? Створити",
      ...
      reg_first: "Ім'я",
      reg_last: "Прізвище",
      reg_age: "Вікова група",
      reg_age_ph: "Виберіть",
      reg_id: "ID",
      reg_id_ph: "Виберіть ID",
      reg_pw: "Пароль",
      reg_pw_ph: "8+ символів, літери й цифри",
      reg_submit: "Зареєструватися",
      reg_creating: "Створення…",
      reg_have_account: "Вже маєте акаунт? Увійти",
      reg_err_name: "Введіть ім'я та прізвище.",
      reg_err_age: "Виберіть вікову групу.",
      reg_err_id: "ID має містити щонайменше 3 символи (літери, цифри, підкреслення).",
      reg_err_pw: "Пароль має містити 8+ символів із літерами та цифрами.",
      reg_err_taken: "Цей ID вже зайнятий. Виберіть інший.",
      reg_err_generic: "Не вдалося зареєструватися. Спробуйте ще раз.",
      reg_done: "Акаунт створено! Перенаправлення…",
      ...
      question_single: "Питання",
      err_submit: "Помилка під час надсилання/оцінювання:",
      err_generic: "Щось пішло не так.",
      code_run: "Запустити",
      code_output: "Вивід",
      code_stdin: "Ввід (stdin)",
      code_stdin_ph: "По одному значенню в рядку (для input())",
      code_running: "Виконання…",
      code_loading: "Завантаження Python…",
      code_no_output: "(немає виводу)",
      code_timeout: "Час виконання вичерпано (можливо, нескінченний цикл). Зупинено через 10 с.",
      code_loadfail: "Не вдалося завантажити Python. Перевірте з'єднання та спробуйте ще раз.",
      start: "Почати",
